...
<el-card>
    <el-row>
        <el-col :span="8">
         ...
         clearable  v-model="queryInfo.query" @clear="getOrderList">
    ...
    <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="操作" >
            <template slot-scope="scope">
                ...
                size="mini" @click="showBox(scope.row)"></el-button>
                <el-button type="success" icon="el-icon-location"
                size="mini" @click="showProgressBox(scope.row)"></el-button>
            </template>
        </el-table-column>
    </el-table>
    <!-- 分页区域 -->
...
<!-- 修改地址的对话框 -->
<el-dialog
  title="修改地址" @close="addressDialogClose"
  ...
  <el-form-item label="详细地址" prop="address2">
    <el-input v-model="addressForm.address2" id="address2"></el-input>
  </el-form-item>
  </el-form>
...
<el-dialog
 ...
 <el-timeline>
    <el-timeline-item
      v-for="(item, index) in progressInfo.data"
      :key="index"
      :timestamp="item.time">
      {{item.context}}
    </el-timeline-item>
