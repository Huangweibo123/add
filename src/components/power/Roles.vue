...
<!-- 卡片视图 -->
  <el-card>
    ...
    <el-row>
        <el-col>
            <el-button type="primary" @click="addDialogRole=true">添加角色</el-button>
        </el-col>
    </el-row>
    <!-- 角色列表区域 -->
    <el-table :data="rolelist" border stripe>
        ...
        <el-table-column type="expand">
            <template slot-scope="scope">
             <el-row :class="['bdbottom',i1===0 ? 'bdtop':'','vcenter','bdmain']" v-for="(item1,i1) in scope.row.children" :key="item1.id">
                <!-- 渲染一级权限 -->
                <el-col :span="5">
  ...
  <el-form :model="addRole" :rules="addRoleRules" ref="addRoleRef" label-width="80px">
    <el-form-item label="角色名称" prop="roleName" >
        <el-input v-model="addRole.roleName" id="roleName" size="small"></el-input>
    </el-form-item>
    <el-form-item label="角色描述" prop="roleDesc" >
        <el-input v-model="addRole.roleDesc" id="roleDesc" size="small"></el-input>
    </el-form-item>
  </el-form>
  <!-- 底部信息 -->
...
<el-dialog
  ...
  ref="editFormRef" label-width="80px">
    <el-form-item label="角色名称" prop="roleName" >
        <el-input v-model="editForm.roleName" id="roleName"
         size="small"  disabled></el-input>
    </el-form-item>
    <el-form-item label="角色描述" prop="roleDesc" >
        <el-input v-model="editForm.roleDesc" id="roleDesc" size="small"></el-input>
    </el-form-item>
  </el-form>
  <span slot="footer" class="dialog-footer">
