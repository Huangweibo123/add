...
<el-dialog
  ...
  <el-form-item label="用户名" prop="username">
    <el-input v-model="addForm.username" id="username"></el-input>
  </el-form-item>
  <el-form-item label="密码" prop="password">
    <el-input v-model="addForm.password" id="password"></el-input>
  </el-form-item>
  <el-form-item label="邮箱" prop="email">
    <el-input v-model="addForm.email" id="email"></el-input>
  </el-form-item>
  <el-form-item label="手机" prop="mobile">
    <el-input v-model="addForm.mobile" id="mobile"></el-input>
  </el-form-item>
  </el-form>
  <!-- 底部区域 -->
